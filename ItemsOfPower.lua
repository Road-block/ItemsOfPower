...
do -- ItemsOfPower:UpdateInspectValueFrame(force)
...
do -- ItemsOfPower:Compare(CompMode, ShowBase, ReverseColor, SwapComparison, ...)
...
do -- ItemsOfPower:GetTooltipText(ItemString)
	local BaseItem = {}
	local CompareItem1 = {}
	local CompareItem2 = {}
...
do -- ItemsOfPower:ApplyItemModifications(BaseItem, CompareItem1, CompareItem2)
...
do -- ItemsOfPower:GetInventorySlot(ItemLink)
	local slot1 = {
		INVTYPE_AMMO			= 0,
...
do -- ItemsOfPower:GetInspectEquipment()
	local slots = {
		["Head"] = true,
		["Neck"] = true,
		["Shoulder"] = true,
