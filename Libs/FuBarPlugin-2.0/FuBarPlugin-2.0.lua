...
local MINOR_VERSION = "$Revision: 18340 $"
...
local function IsMinimapSquare()
	return IsAddOnLoaded("CornerMinimap") or IsAddOnLoaded("SquareMinimap") or IsAddOnLoaded("Squeenix") or (IsAddOnLoaded("simpleMinimap") and simpleMinimap:HasModule("skins") and simpleMinimap_Skins:GetShape() == "square")
end
